...
concordant_enrichment <- GO_and_KEGG_gsea(TWAS_mixture_assignment, column = "P_equal_effects") 
female_specific_enrichment <- GO_and_KEGG_gsea(TWAS_mixture_assignment, column = "P_female_specific")
male_specific_enrichment   <- GO_and_KEGG_gsea(TWAS_mixture_assignment, column = "P_male_specific")
sex_antag_enrichment <- GO_and_KEGG_gsea(TWAS_mixture_assignment, column = "P_sex_antag")
```
