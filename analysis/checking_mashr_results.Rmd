...
<!-- The LFSR from the canonical and data-driven approaches are pretty much the same, though results from the data-driven `mashr` analysis are slightly 'more significant' on average (shown by the preponderance of points above the line $y = x$).  -->
