...
This website relates to the forthcoming paper 'Pleiotropic fitness effects across sexes and age classes in the _Drosophila_ genome and transcriptome', by Wong and Holman (for contact info, see [lukeholman.org](https://www.lukeholman.org/)).
...
### [5. Running the GWAS](perfom_gwas.html)
