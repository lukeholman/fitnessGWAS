...
This website relates to the forthcoming paper 'A genome-wide scan for pleiotropic fitness effects on sexes and age classes in _Drosophila_', by Wong and Holman. 
...
This script uses the transcriptomic data on the DGRP from Huang et al. 2015 _PNAS_. In this script, we
