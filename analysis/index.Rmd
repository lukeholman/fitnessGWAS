...
### [3. Calculating quantitative genetic parameters](quantitative_genetics.html)

Using a multivariate random effects model implemented in `brms`, we estimate the heritability of, and genetic covariance among, our four phenotypes based on the genomic relatedness matrix. 
...
### [6. Plots illustrating how adaptive shrinkage affected the results](checking_mashr_results.html)
...
### [9. Quantitative genetic parameters](XXXX.html)

Text here

### [10. Tables of GWAS results](GWAS_tables.html)

Text here

### [11. Tables of TWAS results](TWAS_tables.html)

Text here

### [12. Plot and model the variant effect sizes](plot_models_variant_effects.html)
...
### [13. GO and KEGG enrichment analyses](GO_KEGG_enrichment.html)
