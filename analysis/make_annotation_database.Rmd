...
This table is expanded upon a little in the script `perform_gwas.Rmd`, which also adds the minor allele frequencies, the alleles that were treated as the reference and alternate, etc. 
```{r}
db %>% tbl("variants")
```
