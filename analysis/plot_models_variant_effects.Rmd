...
make_plot1 <- function(posterior, title){
  tibble(
    ...
    theme_bw() + 
    theme(text = element_text(family = "Raleway", size = 10)) +
    theme(plot.title = element_text(hjust = 0), 
          strip.text = element_text(hjust = 0),
          strip.background = element_blank(),
          legend.position = "none")
...
pdf("figures/fig4_mutation_load.pdf", height = 4.7, width = 9.4)
plot_grid(mut_load_correlation_plot,
          arrangeGrob(pp1, pp2, ncol=2), rel_widths = c(1,1.1))
dev.off()
remove_pages(1, "figures/fig4_mutation_load.pdf", "figures/fig4_mutation_load.pdf")
